...
def get_cfg():
    ...
    parser.add_argument("--action_layers", type=str, default='[128,108, 84]', help="layer 구조")
    ...
    parser.add_argument("--n_representation_action2", type=int, default=32, help="")
    ...
    parser.add_argument("--eps_clip_step", type=float, default=0.000, help="clipping epsilon")
    parser.add_argument("--eps_clip_min", type=float, default=0.178, help="clipping epsilon")
    ...
    parser.add_argument("--n_data_parallelism", type=int, default=5, help="data parallelism")
